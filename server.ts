    ...
    try {
      ...
      const [saved] = await db
        ...
        .values({
          ...
          schoolLatitude: data.schoolLatitude ?? -20.334154,
          schoolLongitude: data.schoolLongitude ?? 29.896333,
...
3. GPS Geofence Verification:
   - Campus Coordinates: Latitude -20.334154, Longitude 29.896333.
...
- **Campus Center:** Latitude \`-20.334154\`, Longitude \`29.896333\` (Dadaya High School Campus Perimeter).
