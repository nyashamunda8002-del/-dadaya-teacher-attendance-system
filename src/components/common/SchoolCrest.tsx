  ...
  return (
    <div className={`flex flex-col items-center select-none ${className}`}>
      <div className={`relative ${sizeMap[size]} flex items-center justify-center`}>
        {/* Authentic Dadaya High School Crest SVG */}
        <svg
          viewBox="0 0 120 144"
        ...
        >
          ...
          <defs>
            {/* Text paths for curved HIGH SCHOOL text */}
            <path
              id="high-path"
              d="M 16,128 Q 30,138 48,142"
              fill="none"
            />
            <path
              id="school-path"
              d="M 72,142 Q 90,138 104,128"
              fill="none"
            />
            {/* Inner motto text paths */}
            <path
              id="motto-top"
              d="M 34,42 Q 60,30 86,42"
              fill="none"
            />
            <path
              id="motto-left"
          ...
          {/* Top curve with 2 raised outer horns and dip in center */}
          <path
          ...
          {/* Bottom Angled: TEMPILO (left) & DZIDZO (right) */}
          <text
            x="40"
            y="100"
            fontSize="5.2"
          ...
          {/* 5. Red Crown / Torch Motif at top of White Plaque */}
          <path
            ...
            strokeLinejoin="round"
          />
          {/* Black band at crown base */}
          <path
            d="M 48,43 Q 60,46 72,43"
            stroke="#1F2937"
            strokeWidth="1.4"
            fill="none"
          />
          ...
          {/* Page Details */}
          <path
            d="M 37,73 Q 48,77 60,74 Q 72,77 83,73"
            stroke="#1F2937"
            strokeWidth="1.2"
            fill="none"
          />

          {/* "DADAYA" Title inside the Red Book */}
          <text
            x="60"
            y="67"
            fontSize="7.5"
          ...
          {/* 7. Red Pen Nib / Quill pointing downward */}
          <path
          ...
          {/* 8. Outer "HIGH SCHOOL" Text underneath the shield */}
          <text
            fontSize="9"
            fontWeight="900"
